...
function index() {
  return (
    ...
    <ul>
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Budaniya Technologies LLP,
          madhopura,balarn,sikar,Rajasthan (332401).
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      You are entitled to cancel Your Order within 30 days without giving any
      reason for doing so.
    </p>
    <p>
    ...
    <ul>
        <br />
      <li>
        <p>By email: contact@budaniyatechnologies.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:{" "}
          <a
            href="https://budaniyatechnologies.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://budaniyatechnologies.com/contact
          </a>
        </p>
      </li>
      <li>
    ...
    <p>madhopura,balaran,sikar,Rajasthan (332401)</p>
    <p>
