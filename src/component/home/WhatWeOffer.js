...
function WhatWeOffer() {
  return (
    <section id="testimonies" className="bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] py-20 bg-slate-900">
      <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div className="mb-12 space-y-5 md:mb-16 md:text-center">
            <div className="inline-block px-3 py-1 text-ld font-semibold text-indigo-100 rounded-lg bg-[#202c47] bg-opacity-60 hover:cursor-pointer hover:bg-opacity-40">
              Our Services
            </div>
            <h1 className="mb-5 text-3xl font-semibold text-white md:text-5xl">What We Offer</h1>
            <p className="text-xl text-gray-100 md:text-xl">There are many variations of passages of Lorem Ipsum available but the majority have<br /> suffered alteration in some form.</p>
          </div>
        </div>
          ...
          {[
            {
              ...
              title: "UI Intigration",
              img: "https://img.freepik.com/premium-vector/logo-brand-design_23785-9.jpg?w=360",
              text: "The most common reasons are to rebrand your site, increase your traffic, generate more leads, and add functionality to improve the user experience.",
            },
            {
              name: "Regular Updates",
              // title: "CEO of PayPal",
              img: "https://i.pinimg.com/236x/a3/4b/5a/a34b5ac5baf97eece5ecd74cee740e17.jpg",
              text: "There are several trends in web technology, ranging from AI features and functionality to serverless architecture and the growth of animated UIs and dark mode.",
            },
            {
              name: "Experience Team",
              // title: "",
              img: "https://pbs.twimg.com/profile_images/1535420431766671360/Pwq-1eJc_400x400.jpg",
              text: "The web development team can be thought of as an IT crew that takes care of the code for one or multiple websites and apps.",
            },
            {
              name: "Support",
              // title: "Ex-CEO of Twitter",
              img: "https://cdn.vectorstock.com/i/500p/56/81/gear-and-wrench-icon-service-support-logo-vector-20755681.jpg",
              text: "Web development services encompass creating, building, and maintaining websites or web applications for long term.",

            },
            {
              name: "Speed Optimized",
              // title: "CEO of Microsoft",
              img: "https://www.vhv.rs/dpng/d/94-944969_speed-optimization-logo-hd-png-download.png",
              text: "Website optimization is the process of improving your website's performance across various areas, such as web traffic, conversion rates, and usability.",

            },
            {
              name: "Fully Customizable",
              // title: "CEO of PayPal",
              img: "https://media.istockphoto.com/id/1159741374/vector/creative-icon-of-a-half-brain-half-lightbulb-representing-ideas-creativity-knowledge.jpg?s=612x612&w=0&k=20&c=UggbJ9Wp1K3cGVR8x7zROTUZr9VHxe6vqU_3tgCRpCI=",
              text: "This can include things like changing the color scheme, font size, or layout of a website, or adding or removing certain features.",

            },

          ].map((testimonial, idx) => (
            <div key={idx} className="relative group text-sm leading-6">
              <div className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
              <a className="relative block p-6 space-y-6 rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                <div className="flex items-center space-x-4">
                  <img
                    src={testimonial.img}
                    alt={testimonial.name}
                    className="w-12 h-12 bg-cover border rounded-full"
                  />
                  <div>
                ...
                <p className="leading-normal text-gray-300 text-md">{testimonial.text}</p>
              </a>
            </div>
          ))}
        </div>
...
// function WhatWeOffer() {
//   return (
//     <section className="pt-4  lg:pt-[50px] lg:pb-[70px] dark:bg-dark">
...
//             <div className="mb-9 rounded-[20px] bg-transparents  border dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
...
//           </div>
//           <div className="w-full px-4 md:w-1/2 lg:w-1/3">
//             <div className="mb-9 rounded-[20px] bg-transparent  border dark:bg-dark-2 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
//               <div className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl">
//                 <svg
//                   width={36}
//                   height={36}
