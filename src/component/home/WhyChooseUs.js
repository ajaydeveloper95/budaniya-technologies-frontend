    ...
    <div className="py-16">
      <div className="max-w-4xl mx-auto px-5">
        <div className="text-center">
          <h2 className="font-semibold text-3xl text-white">Features you'll love</h2>
          <p className="max-w-md mx-auto mt-2 text-gray-300">
            A responsive documentation template built for everyone who wants to create
            a plugin.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Customizable</h3>
              <p className="mt-1 text-gray-300">
                {" "}
                You don't need to be an expert to customize this plugin. Our code is
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Fully Responsive</h3>
              <p className="mt-1 text-gray-300">
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Developer Support</h3>
              <p className="mt-1 text-gray-300">
                {" "}
                Our plugins are supported by sponsors who provide community support.
                Sponsors will get email support on weekdays.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Cross Browser</h3>
              <p className="mt-1 text-gray-300">
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Clean Code</h3>
              <p className="mt-1 text-gray-300">
                {" "}
                We strictly follow a set of guidelines along with unit tests to make
                sure your implementation as easy as possible.{" "}
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-white">Well Maintained</h3>
              <p className="mt-1 text-gray-300">
                {" "}
                This templatte is actively maintained by the core plugin team. We are
                working on fixing each of the issues reported.
              </p>
            </div>
          </div>
        </div>
